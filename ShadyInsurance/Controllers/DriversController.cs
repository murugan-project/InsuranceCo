...
namespace ShadyInsurance.Controllers
{
    public class DriversController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Address,City,State")] Driver driver)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Address,City,State")] Driver driver)
        {
            if (ModelState.IsValid)
            {
